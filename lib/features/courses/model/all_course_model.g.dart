...
_$AllCourseModelImpl _$$AllCourseModelImplFromJson(Map<String, dynamic> json) =>
    _$AllCourseModelImpl(
...
Map<String, dynamic> _$$AllCourseModelImplToJson(
        _$AllCourseModelImpl instance) =>
    <String, dynamic>{
