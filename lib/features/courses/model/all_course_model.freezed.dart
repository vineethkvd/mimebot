...
AllCourseModel _$AllCourseModelFromJson(Map<String, dynamic> json) {
  return _AllCourseModel.fromJson(json);
}

/// @nodoc
mixin _$AllCourseModel {
  @JsonKey(name: "status")
  ...
  @JsonKey(ignore: true)
  $AllCourseModelCopyWith<AllCourseModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AllCourseModelCopyWith<$Res> {
  factory $AllCourseModelCopyWith(
          AllCourseModel value, $Res Function(AllCourseModel) then) =
      _$AllCourseModelCopyWithImpl<$Res, AllCourseModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AllCourseModelCopyWithImpl<$Res, $Val extends AllCourseModel>
    implements $AllCourseModelCopyWith<$Res> {
  _$AllCourseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AllCourseModelImplCopyWith<$Res>
    implements $AllCourseModelCopyWith<$Res> {
  factory _$$AllCourseModelImplCopyWith(_$AllCourseModelImpl value,
          $Res Function(_$AllCourseModelImpl) then) =
      __$$AllCourseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "status") String? status,
...
/// @nodoc
class __$$AllCourseModelImplCopyWithImpl<$Res>
    extends _$AllCourseModelCopyWithImpl<$Res, _$AllCourseModelImpl>
    implements _$$AllCourseModelImplCopyWith<$Res> {
  __$$AllCourseModelImplCopyWithImpl(
      _$AllCourseModelImpl _value, $Res Function(_$AllCourseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AllCourseModelImpl(
      status: freezed == status
          ? _value.status
          : status // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$AllCourseModelImpl implements _AllCourseModel {
  const _$AllCourseModelImpl(
      {@JsonKey(name: "status") this.status = '',
      @JsonKey(name: "message") this.message = '',
      @JsonKey(name: "Data") final List<Data>? data = const []})
      : _data = data;

  factory _$AllCourseModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$AllCourseModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'AllCourseModel(status: $status, message: $message, data: $data)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AllCourseModelImplCopyWith<_$AllCourseModelImpl> get copyWith =>
      __$$AllCourseModelImplCopyWithImpl<_$AllCourseModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AllCourseModelImplToJson(
      this,
    );
  }
}

abstract class _AllCourseModel implements AllCourseModel {
  const factory _AllCourseModel(
      {@JsonKey(name: "status") final String? status,
      @JsonKey(name: "message") final String? message,
      @JsonKey(name: "Data") final List<Data>? data}) = _$AllCourseModelImpl;

  factory _AllCourseModel.fromJson(Map<String, dynamic> json) =
      _$AllCourseModelImpl.fromJson;
